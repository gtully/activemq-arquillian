...
public class MDBMessageSendTxExample implements MessageListener
{
   ...
   public void onMessage(Message message)
   {
      ...
      try
      {
         ...
         // second cf - isSameRM=true
         conn2 = connectionFactory2.createConnection();

         Session sess2 = conn2.createSession(false, Session.AUTO_ACKNOWLEDGE);

         MessageProducer producer2 = sess2.createProducer(replyQueue2);

         producer2.send(sess2.createTextMessage("this is a reply2"));
